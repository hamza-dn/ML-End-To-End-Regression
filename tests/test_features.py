...
def test_load_and_split_data_creates_splits(tmp_path):
    ...
    assert (tmp_path / "train_raw.csv").exists()
    assert (tmp_path / "eval_raw.csv").exists()
...
def test_drop_duplicates_removes_dupes():
    ...
    # Current behavior keeps first duplicate row.
...
def test_full_pipeline_integration(tmp_path):
    ...
    train.to_csv(tmp_path / "train_raw.csv", index=False)
    eval.to_csv(tmp_path / "eval_raw.csv", index=False)
    holdout.to_csv(tmp_path / "holdout_raw.csv", index=False)
